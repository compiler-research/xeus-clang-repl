...
#define XEUS_CLANG_REPL_VERSION XEUS_CLING_STRINGIFY(XEUS_CLING_CONCATENATE(XEUS_CLANG_REPL_VERSION_MAJOR,   \
                       XEUS_CLING_CONCATENATE(.,XEUS_CLING_CONCATENATE(XEUS_CLANG_REPL_VERSION_MINOR,   \
                                              XEUS_CLING_CONCATENATE(.,XEUS_CLANG_REPL_VERSION_PATCH)))))
